    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            while (loop)
            {
                ...
                {
                    case 1:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Sample Solvable Puzzles";
                        break;
                    case 2:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Sample Unsolvable Puzzles";
                        break;
                    case 3:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Complete Solvable puzzles\Manhattan & Hamming";
                        break;
                    case 4:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Complete Solvable puzzles\Manhattan Only";
                        break;
                    case 5:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Complete V. Large test case";
                        break;
                    case 6:
                        folder = @"E:\computer science\level3\term 2\algo\NPuzzle\NPuzzle\test_cases\Complete Unsolvable puzzles";
                        break;
                }
